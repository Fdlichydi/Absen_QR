    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <div class="d-flex justify-content-center align-items-center">
                <a href="/logout"><i class="dw dw-logout"></i> Logout</a>
            </div>
        ...
        <div class="brand-logo">
            <a href="">
                {{-- <img src="{{ asset('assets/backend/vendors/images/deskapp-logo.svg') }}" alt=""
                    class="dark-logo" /> --}}
                {{-- <img src="{{ asset('assets/backend/vendors/images/deskapp-logo-white.svg') }}" alt=""
                    class="light-logo" /> --}}
                    <span class="mtext" style="color: black">Nama Sekolah</span>
                    {{-- <span class="mtext">Nama Sekolah</span> --}}
            </a>
                ...
                <ul id="accordion-menu">
                    <li>
                        <a href="/siswa" class="dropdown-toggle no-arrow">
                            <span class="micon fa fa-users"></span><span class="mtext">Siswa</span>
                        </a>
                    </li>
                    <li>
                        <a href="/jurusan" class="dropdown-toggle no-arrow">
                            <span class="micon fa fa-sun-o"></span><span class="mtext">Jurusan</span>
                        </a>
                    </li>
                    <li>
                        <a href="/absensi" class="dropdown-toggle no-arrow">
                            <span class="micon fa fa-hand-paper-o"></span><span class="mtext">Absen</span>
                        </a>
                    </li>
                    <li>
                        <a href="/scan" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-qr-code-scan"></span><span class="mtext">Scan</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-toggle no-arrow" href="{{ route('dailyReport') }}">
                            <span class="micon dw dw-calendar"></span><span class="mtext">Laporan Harian</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-toggle no-arrow" href="{{ route('monthlyReport') }}">
                            <span class="micon dw dw-calendar-1"></span><span class="mtext">Laporan Bulanan</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-toggle no-arrow" href="{{ route('periodReport') }}">
                            <span class="micon dw dw-calendar-2"></span><span class="mtext">Laporan Per-Priode</span>
                        </a>
                    </li>
                    <li>
